...
import { Gift, Shirt, Coffee, Backpack, Sparkles, Ticket } from 'lucide-react';
          ...
          <div className="relative z-10 w-full pt-8 border-t border-slate-200 dark:border-slate-700/50">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
              ...
              <div className="bg-white/60 dark:bg-slate-800/60 p-4 rounded-2xl text-center border border-slate-200 dark:border-slate-700 hover:scale-105 transition-transform shadow-sm">
                ...
                <div className="text-[11px] text-slate-500">Gadgets & Stickers</div>
              </div>
            </div>
          </div>
        </div>
...
function SwagCard({ image, name, milestone, color }: any) {
  return (
    <div className="glass-panel rounded-2xl overflow-hidden shadow-sm text-left group">
