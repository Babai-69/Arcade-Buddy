  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="glass-card p-8 md:p-12">
        <h1 className="text-3xl font-display font-bold mb-4 text-slate-900 dark:text-white">Privacy Policy</h1>
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
          ...
          <p>Additionally, as you browse the Site, we collect information about the individual web pages that you view, what websites or search terms referred you to the Site, and information about how you interact with the Site.</p>
          
          <h2 className="text-xl font-bold text-slate-900 dark:text-white mt-8 mb-4">How We Use Information</h2>
          ...
          <h2 className="text-xl font-bold text-slate-900 dark:text-white mt-8 mb-4">Cookies & Analytics</h2>
