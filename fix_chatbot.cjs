...
const themes = [
  { hex: '#4285F4', bg: '#0b1120' }, // Google Blue
  { hex: '#00FF88', bg: '#0a0f0a' }, // Green
  { hex: '#A855F7', bg: '#160d21' }, // Purple
  { hex: '#F43F5E', bg: '#1f0d14' }, // Rose
  { hex: '#FBBC05', bg: '#1a1608' }  // Google Yellow
];

const newChatBot = `import React, { useState, useEffect, useRef } from 'react';
...
fs.writeFileSync('src/components/ChatBot.tsx', newChatBot);
